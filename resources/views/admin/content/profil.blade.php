            ...
            <div class="page-wrapper">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-xlg-9 col-md-7">
                        <div class="card">
                            <div class="card-body">
                                <form onsubmit="return validasi_input1(this)" class="form-horizontal form-material" action="/admin/postUpdateProfil/{{$admin->id_admin}}" method="POST" enctype="multipart/form-data">
                                    {{csrf_field()}}
                    ...
                    <div class="col-lg-8 col-xlg-3 col-md-5">
                        <div class="card">
                            <div class="card-body profile-card">
                                ...
                                <form onsubmit="return validasi_input(this)" action="/admin/updatePassword/{{$admin->id_admin}}" method="POST" enctype="multipart/form-data">
                                    {{csrf_field()}}
                ...
                <script type="text/javascript">
                    function validasi_input1(form) {
                        if (form.nama.value == "") {
                            alert("Anda belum mengisi Nama !");
                            return (false);
                        } else if (form.username.value == "") {
                            alert("Anda belum mengisi Usernama !");
                            return (false);
                        } else if (form.alamat.value == "") {
                            alert("Anda belum mengisi Alamat !");
                            return (false);
                        } else if (form.kontak.value == "") {
                            alert("Anda belum mengisi Kontak !");
                            return (false);
                        }
                        return (true);
                    }
