            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="signup-card card-block auth-body mr-auto ml-auto">
                        <form action="/petani/updateForgot" class="md-float-material" method="POST">
                            {{csrf_field()}}
                            <div class="auth-box">
                                ...
                                <div class="row m-t-30">
                                    <div class="col-md-12">
                                        <button type="submit" class="btn btn-primary btn-md btn-block waves-effect text-center m-b-20">Kirim</button>
                                    </div>
                                </div>
                                <hr />
                                <div class="row">
